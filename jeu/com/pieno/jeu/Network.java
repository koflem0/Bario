...
public class Network
{
	...
	public static final int POW = 0, AGI = 1, SPIRIT = 2, VIT = 3, CRIT = 4, CRITDMG = 5, MASTERY = 6, ALLSTATS = 7, HP = 11, MANA = 10, IF = 8, RF = 9,
			DEFENSE = 12, WATK = 13;
	public static final int ARROW = 0, ENERGY = 2, FIRE = 3;
	public static final int EXPLOSION = 0, EXPLOARROW = 1, LVLUP = 2;
	public static final int walkL = 0, walkR = 1, standL = 2, standR = 3, jumpR = 4, jumpL = 5, climb = 6, onladder = 7, climbSide = 8, wizwalkL = 9, wizwalkR = 10,
			wizstandL = 11, wizstandR = 12, wizjumpL = 13, wizjumpR = 14, wizclimb = 15;
