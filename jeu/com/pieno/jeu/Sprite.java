...
public class Sprite
{
	...
	public synchronized void update(long timePassed)
	{
		...
		if (nextX <= 80 && nextX >= -80) setX(x + nextX);
		float nextY = vy * timePassed;
		if (nextY <= 80 && nextY >= -80) setY(y + nextY);
		if (a != null) a.update(timePassed);
	}
	...
	public int getWidth()
	{
		if (a != null) return a.getImage().getWidth(null);
		else return 0;
	}

	public int getHeight()
	{
		if (a != null) return a.getImage().getHeight(null);
		else return 0;
	}
