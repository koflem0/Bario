	...
	private void getStats(){
		...
		for(int i = 0; i < 12; i++){
			if(item.getStat(i)!=0) {
				...
				switch(i){
				case Network.ALLSTATS: stats[number]+=" to all stats"; break;
				case Network.SPIRIT: stats[number]+=" Spirit"; break;
				case Network.POW: stats[number]+=" Power"; break;
				case Network.AGI: stats[number]+=" Agility"; break;
				case Network.VIT: stats[number]+=" Vitality"; break;
				case Network.CRITDMG: stats[number]+="% Crit damage"; break;
				case Network.CRIT: stats[number]+="% Crit chance"; break;
				case Network.MASTERY: stats[number]+=" Mastery"; break;
				case Network.IF: stats[number]+="% Item Find"; break;
