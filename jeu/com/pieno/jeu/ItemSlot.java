...
public class ItemSlot implements Serializable
{
	...
	/*
	 * public ItemSlot(int i, int j, Stash stash){ this.i = i; this.j = j;
	 * this.stash = stash; area = new Rectangle(Stash.x+20+i*55,
	 * Stash.y+100+j*55,50,50); } public void activate(boolean drop){ if(equip){
	 * inventory.unequip(i); } else { if(drop) inventory.drop(i, j); else
	 * inventory.equip(i,j); } }
	 */
