...
public class CharacterAnimation
{
	...
	{
		if (getAnimation() != null) getAnimation().update(timePassed);
		if (skillAnimation != null) if (skillAnimation.getTime() > skillAnimation.getTotalTime() * 2 / 3) skillFinished = true;
